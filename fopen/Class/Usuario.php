...
// $sql = new Sql(); $sql->setDeslogin("Hydena"); $sql->setDessenha("caracas13"); $sql->insertPer();
    public function insert()
    {
        ...
        public function insertPer() // $sql = new Sql(); $sql->setDeslogin("Hydena"); $sql->setDessenha("caracas13"); $sql->insertPer(); 
    {
        $sql = new Sql();
    ...
    public function __construct($login = "", $password = "") // $sql = new Sql("Hydena", "caracas13"); $sql->insertPer();
    {
        $this->setDeslogin($login);
        $this->setDessenha($password);
